...
RETURNING id, from_account_id, to_account_id, amount, created_at, deleted_at
`
...
SELECT id, from_account_id, to_account_id, amount, created_at, deleted_at FROM transfers
